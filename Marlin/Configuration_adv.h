...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLERFAN_SPEED_ACTIVE 196 // (0-255) Active speed, used when any motor is enabled
...
#define EXTRUDER_AUTO_FAN_SPEED 196   // 255 == full speed
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE {60*60, 60*60, 12*60, 6*60} // Feedrates for manual moves along X, Y, Z, E from panel
